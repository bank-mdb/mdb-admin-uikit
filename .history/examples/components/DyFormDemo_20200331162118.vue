<template>
  <div class="dy-form-demo">
    <dy-form ref="dyForm" label-position="right" :showSubmitButton="false" :submitFunction="submitHandle" :model="formModel" :formItems="formItems" label-width="130px"></dy-form>
