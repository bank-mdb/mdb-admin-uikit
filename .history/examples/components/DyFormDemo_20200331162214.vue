<template>
  <div class="dy-form-demo">
    <dy-form ref="dyForm" label-position="right" :submitFunction="submitHandle" :model="formModel" :formItems="formItems" label-width="130px"></dy-form>
  ...
  methods: {
    submitHandle(){
      try {
        ...
        this.$refs.dyForm.loadingData = false
      } catch(err) {
        console.log("失败", err)
      }
